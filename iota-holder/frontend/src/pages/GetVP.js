                ...
                if(res.data==="Exist"){
                    ...
                    .then((res) => {
                        ...
                        downloadFile
                            ...
                            .then((res) => {
                            console.log(res);
                            FileDownload(res.data, username.concat("-presentation.json"));
                            setLoading(false)
                            })
                            .catch((err) => {
                                console.log(err);
        ...
        <div id="login">
            <div className="card-body">
                ...
                <div className="form-control">
                    ...
                    <input type="text" placeholder="fragment" className="input-bordered" value={verificationMethod} onChange={handleVC}/>
                </div>
                <div className="form-control">
                    <span className="label-text"><p>Challenge:    </p></span>
                    <input type="text" placeholder="challenge" className="input-bordered" value={challenge} onChange={handleChallenge}/>
                </div>
                <div className='form-control'>
                    <span className="label-text"><p>Credential File: </p></span>
